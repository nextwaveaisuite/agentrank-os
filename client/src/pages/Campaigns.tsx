    ...
    try {
      ...
      if (d.campaign?.id) {
        await fetch("/.netlify/functions/research", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ campaignId: d.campaign.id, mode, niche: finalNiche, location: mode === "business" ? location : "Global", industry: finalIndustry }),
        });
      }
      setLocation("/leads");
    } catch {
      alert("Could not launch campaign. Please try again.");
    } finally {
      setSaving(false);
    }
  };
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
            ...
            {mode === "affiliate" && (
              <div style={{ background: "#052e16", border: "1px solid #166534", borderRadius: 10, padding: "12px 16px", marginBottom: 20 }}>
                <p style={{ margin: 0, fontSize: 13, color: "#86efac" }}>
                  <strong>Affiliate mode</strong> — Alex finds targeted buyers already interested in your niche. Sam sends personalised messages pointing them to your offer link. Jordan follows up automatically. Zero human involvement needed.
                </p>
              </div>
            )}
        ...
        {step === 2 && mode === "affiliate" && (
          <div>
            ...
            <p style={{ fontSize: 12, color: "#475569", marginBottom: 16 }}>Alex will find targeted buyers and Sam will send them personalised messages linking to this URL.</p>
          ...
          <div>
            ...
            <div style={{ ...card, marginBottom: 20 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
                ...
                <span style={{ fontSize: 12, padding: "2px 8px", background: "#1D3461", color: "#60A5FA", borderRadius: 6 }}>Toggle to pause & review</span>
              </div>
            ...
            {mode === "affiliate" && autoResearch && autoWrite && autoOutreach && autoQualify && (
              <div style={{ background: "#052e16", border: "1px solid #166534", borderRadius: 10, padding: "12px 16px", marginBottom: 16 }}>
                <p style={{ margin: 0, fontSize: 13, color: "#86efac" }}>✓ Full autopilot enabled — your AI team will work 24/7 with zero human involvement.</p>
              </div>
            )}
            <div style={{ display: "flex", gap: 10 }}>
