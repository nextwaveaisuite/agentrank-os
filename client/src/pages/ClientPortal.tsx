    ...
    <div style={{ minHeight: "100vh", background: "#0F172A" }}>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "2rem 1rem" }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ color: "#64748B", fontSize: 15, margin: 0 }}>{client.business_name || "Your business"}</p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 12, marginBottom: 28 }}>
          {[
            ...
            { label: "Leads limit", value: client.leads_limit === 999 ? "Unlimited" : client.leads_limit },
        ...
        {!isActive && (
          <div style={{ background: "#1E293B", border: "1px solid #F59E0B", borderRadius: 12, padding: 28, textAlign: "center", marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: "#64748B", margin: "0 0 20px" }}>Choose a plan to start receiving leads from your AI team.</p>
