...
import { Search, PenLine, Send, Filter, PhoneCall, BarChart3, ChevronRight, Rocket, Mail, Users, Zap, Shield, TrendingUp, FolderOpen, Layout } from "lucide-react";
  ...
  const Header = () => (
    <header style={hdr}>
      ...
      <nav style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <Link href="/client-login"><a style={{ color: "#94A3B8", fontSize: 14, textDecoration: "none", padding: "8px 14px" }}>Client Login</a></Link>
    ...
    <footer style={{ borderTop: "1px solid #1E293B", padding: "2rem", background: "#0F172A" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
        ...
        <div style={{ display: "flex", gap: 20 }}>
          {["Pricing", "Client Login", "Privacy", "Terms"].map(i => (
      ...
      <div style={{ maxWidth: 960, margin: "0 auto 2rem", padding: "0 1rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: "3rem" }}>
          {[
            ...
            { icon: Shield, title: "Dual mode", desc: "Find business clients AND drive affiliate buyer traffic", color: "#10B981" },
            { icon: TrendingUp, title: "Revenue focused", desc: "Built to close deals and convert affiliate sales", color: "#3B82F6" },
          ].map(f => {
            const Icon = f.icon;
            return (
